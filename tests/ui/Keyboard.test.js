...
describe('which plugins get a keyboard', () => {
  ...
  it('gives one to what a person plays and to nothing else', async () => {
    ...
    expect(not).toEqual(['bassgen', 'boost', 'cascade', 'drumgen', 'dynamix', 'ferrite', 'ground', 'jsfx-gain-trim', 'jsfx-one-pole-filter', 'jsfx-soft-clipper', 'melgen', 'quefrency', 'squelch', 'tremolo'])
  })
