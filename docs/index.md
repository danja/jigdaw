...
agent tool surface. 16 worked plugins: a subtractive synth, a bass line generator, a
...
and a phrase-aware melody generator. Foreign plugins (Web Audio Modules) load and play, marked
