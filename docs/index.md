...
agent tool surface. 17 worked plugins: a subtractive synth, a bass line generator, a
...
a phrase-aware melody generator, and a long-form bass section planner. Foreign plugins (Web Audio Modules) load and play, marked
