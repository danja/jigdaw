...
browser, a second host that runs them as a VST3, 16 worked plugins, and a validator that
...
16 worked plugins are in [plugins/](plugins/): a subtractive synth,
...
instrument and a phrase-aware melody generator, all seven written in Rust
