...
cp target/wasm32-unknown-unknown/release/cascade.wasm cascade.wasm

node "$root/bin/write-profile.js" "$here"
echo "built $(wc -c < cascade.wasm) bytes of wasm, profile.ttl regenerated"
