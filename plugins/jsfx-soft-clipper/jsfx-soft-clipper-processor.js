// plugins/jsfx-soft-clipper/jsfx-soft-clipper-processor.js
//
...
class JsfxProcessor extends AudioWorkletProcessor {
  static get parameterDescriptors () {
    return [
    { name: "slider1", defaultValue: 1, minValue: 1, maxValue: 20, automationRate: 'k-rate' },
    { name: "slider2", defaultValue: 0, minValue: 0, maxValue: 1, automationRate: 'k-rate' }
    ]
  }
...
registerProcessor("jsfx-soft-clipper", JsfxProcessor)
