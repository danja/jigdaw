...
cp target/wasm32-unknown-unknown/release/drumkit.wasm drumkit.wasm

node "$root/bin/write-profile.js" "$here"
echo "built $(wc -c < drumkit.wasm) bytes of wasm, profile.ttl regenerated"
