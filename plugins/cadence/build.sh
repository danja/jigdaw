...
cp target/wasm32-unknown-unknown/release/cadence.wasm cadence.wasm

node "$root/bin/write-profile.js" "$here"
echo "built $(wc -c < cadence.wasm) bytes of wasm, profile.ttl regenerated"
