...
cp target/wasm32-unknown-unknown/release/melgen.wasm melgen.wasm

node "$root/bin/write-profile.js" "$here"
echo "built $(wc -c < melgen.wasm) bytes of wasm, profile.ttl regenerated"
