...
cp target/wasm32-unknown-unknown/release/ground.wasm ground.wasm

node "$root/bin/write-profile.js" "$here"
echo "built $(wc -c < ground.wasm) bytes of wasm, profile.ttl regenerated"
