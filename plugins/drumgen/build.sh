...
cp target/wasm32-unknown-unknown/release/drumgen.wasm drumgen.wasm

node "$root/bin/write-profile.js" "$here"
echo "built $(wc -c < drumgen.wasm) bytes of wasm, profile.ttl regenerated"
