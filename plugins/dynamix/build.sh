...
cp target/wasm32-unknown-unknown/release/dynamix.wasm dynamix.wasm

node "$root/bin/write-profile.js" "$here"
echo "built $(wc -c < dynamix.wasm) bytes of wasm, profile.ttl regenerated"
